                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="relative flex items-center justify-center my-2">
                                ...
                                <div className="relative bg-black px-4 text-xs text-gray-500 uppercase tracking-widest">Or</div>
                            </div>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="btn btn-outline btn-full flex items-center justify-center gap-3 hover:bg-white hover:text-black transition-all"
                            ...
                            >
                                ...
                                {loading ? 'Contacting Google...' : 'Sign in with Google'}
                            </button>
                        </div>
                    </form>
